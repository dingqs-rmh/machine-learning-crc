...
with PdfPages('/home/xkj/project/PIK3CA/plots/combined_roc_cm.pdf') as pdf_roc_cm, \
     PdfPages('/home/xkj/project/PIK3CA/plots/combined_shap.pdf') as pdf_shap:
    ...
    for i, (train_idx, test_idx) in enumerate(cv.split(X, y)):
        ...
        # plt.title(f'SHAP Summary Plot Fold {i+1}', fontsize=14, fontweight='bold')
        # pdf_shap.savefig()
        # plt.close()
