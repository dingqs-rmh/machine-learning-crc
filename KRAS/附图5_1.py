...
# 创建PDF文件保存ROC曲线
with PdfPages('/home/xkj/project/KRAS/plots/附图5_1.pdf') as pdf_roc:
    ...
    for i, (train_idx, test_idx) in enumerate(cv.split(X, y)):
        ...
        axes[i].set_title(f'RAS/RAF Fold {i+1}')
...
auc_summary.to_csv('/home/xkj/project/KRAS/metrics/auc_summary.csv', index=False)
